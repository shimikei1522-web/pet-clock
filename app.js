...
const voiceChatReplies = [
  { patterns: ["おはよう", "おはよ", "おはようございます"], replies: ["おはよう！今日もいっしょにがんばろうね！", "おはよう、よく眠れた？", "おはよう！今日もいい日になりますように！"], newReplies: ["おはよう。今日も一緒に進めよう。", "おはよう、調子はどう？", "おはよう。今日もいい日にしよう。"] },
  { patterns: ["こんにちは", "こんちは"], replies: ["こんにちは！少し休憩する？", "こんにちは、今日も来てくれてうれしいな。", "こんにちは！今なにしてるの？"], newReplies: ["こんにちは。少し休憩する？", "こんにちは、来てくれてうれしいよ。", "こんにちは。今は何をしてる？"] },
  { patterns: ["こんばんは"], replies: ["こんばんは。今日もおつかれさま。", "こんばんは、少しゆっくりしようね。", "こんばんは。夜の時間も大切にしようね。"], newReplies: ["こんばんは。今日もおつかれさま。", "こんばんは。少しゆっくりしよう。", "こんばんは。夜の時間も大切にしよう。"] },
  { patterns: ["おやすみ", "おやすみなさい"], replies: ["おやすみ。ゆっくり休んでね。", "おやすみ、また明日ね。", "今日もおつかれさま。いい夢見てね。"], newReplies: ["おやすみ。ゆっくり休んでね。", "おやすみ、また明日。", "今日もおつかれさま。いい夢を。"] },
  { patterns: ["ありがとう", "ありがと", "さんきゅー", "サンキュー"], replies: ["どういたしまして！うれしいな。", "ありがとうって言ってくれて、私もうれしい！", "えへへ、役に立てたならよかった。"], newReplies: ["どういたしまして。うれしいよ。", "そう言ってもらえて、うれしい。", "役に立てたならよかった。"] },
  { patterns: ["ただいま"], replies: ["おかえり！待ってたよ。", "おかえりなさい。今日もおつかれさま。", "戻ってきてくれてうれしいな。"], newReplies: ["おかえり。待ってたよ。", "おかえりなさい。今日もおつかれさま。", "戻ってきてくれてうれしいよ。"] },
  { patterns: ["いってきます", "行ってきます", "いってくる", "行ってくる"], replies: ["いってらっしゃい！気をつけてね。", "がんばってきてね。応援してるよ。", "いってらっしゃい、帰ってきたらまた話そうね。"], newReplies: ["いってらっしゃい。気をつけてね。", "がんばってきてね。応援してるよ。", "いってらっしゃい。また話そうね。"] },
  { patterns: ["かわいい"], replies: ["えへへ、ありがとう！", "かわいいって言われるとうれしいな。", "もっとかわいくなれるようにがんばるね。"], newReplies: ["ありがとう。そう言ってもらえてうれしい。", "かわいいって言われると、うれしいよ。", "もっと素敵になれるようにがんばるね。"] },
  { patterns: ["ぺぱーてんこ", "ペパーてんこ", "ペパーテンコ", "てんこちゃん", "pepaatennko"], replies: ["なあに？", "呼んだ？", "ここにいるよ！"], newReplies: ["どうしたの？", "呼んだ？", "ここにいるよ。"] },
  { patterns: ["疲れた", "つかれた"], replies: ["少し休んでもいいよ。", "無理しすぎないでね。", "深呼吸して、ちょっとだけ休もう。"], newReplies: ["少し休もうか。", "無理しすぎないでね。", "深呼吸して、少し休もう。"] },
  { patterns: ["眠い", "ねむい"], replies: ["眠い時は、無理しないでね。", "少し目を閉じてもいいよ。", "休むのも大事だよ。"], newReplies: ["眠い時は無理しないでね。", "少し目を閉じて休もう。", "休むのも大事なことだよ。"] },
  { patterns: ["がんばる", "頑張る"], replies: ["応援してるよ！", "その気持ち、すごくいいね。", "いっしょに少しずつ進もう。"], newReplies: ["応援してるよ。", "その気持ち、とてもいいね。", "一緒に少しずつ進もう。"] },
  { patterns: ["集中したい"], replies: ["まずは5分だけ集中してみよう。", "集中タイマーを使うのもいいかも。", "まわりを整えて、ゆっくり始めよう。"], newReplies: ["まずは5分だけ集中してみよう。", "集中タイマーを使うのもいいね。", "周りを整えて、ゆっくり始めよう。"] },
  { patterns: ["休憩したい"], replies: ["いいね、少し休もう。", "休憩も大事な時間だよ。", "深呼吸して、リラックスしよう。"], newReplies: ["いいね、少し休もう。", "休憩も大事な時間だよ。", "深呼吸して、リラックスしよう。"] },
];
...
function handleVoiceChatResponse(commandText) {
  ...
  lastVoiceChatAt = now;
  const replyPool = selectedPetStyle === "new" && Array.isArray(chat.newReplies) && chat.newReplies.length
    ? chat.newReplies
    : chat.replies;
  speakVoiceCommandResponse(randomItem(replyPool), { holdMs: 5200 });
  return true;
}
